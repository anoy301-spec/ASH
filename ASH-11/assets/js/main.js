...
document.addEventListener("DOMContentLoaded", function () {
    ...
    init: function () {
      ...
      function closeMenu() {
        ...
        var headerLinks = document.querySelectorAll(
          ".main-menu11.menu-style11 li.active, .main-menu11.menu-style11 li a.active",
        );
      ...
      if (savedIndex) {
        var activeLink = menu.querySelector(
      ...
      menuLinks.forEach(function (link) {
        link.addEventListener("click", function (e) {
          ...
          if (
            ...
            li.classList.contains("has-submenu")
          ) {
            e.preventDefault();
  ...
  var Menu = {
    init: function () {
      var menuLinks = document.querySelectorAll(
        ".main-menu11.menu-style11 ul li > a",
      );
